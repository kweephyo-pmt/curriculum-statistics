  ...
  <div class="flex h-screen">
    ...
    >
      <div class="research space-y-6">
        <h1 class="text-3xl font-semibold text-gray-800">Faculty & Staff</h1>
        <p class="text-lg text-gray-600">Meet our dedicated faculty and staff members.</p>

        <!-- Power BI Embed (full screen except app bar) -->
        <iframe
          title="Faculty & Staff"
          :style="iframeStyle"
          src="https://app.powerbi.com/view?r=eyJrIjoiNjRmZjA2MzEtMWNhMi00NjA2LWFjY2MtNDM2MDY1NWVhYjJhIiwidCI6ImU5NGQ1N2FkLWEwYjctNDRjZi04ODNmLWQ3OTg3YTBiZDI0NCIsImMiOjEwfQ%3D%3D"
          frameborder="0"
